...
def run_analysis(
    *,
    ...
    for struct, resol, label in iterables:
        ...
        if cov_normative:
<<<<<<< HEAD
            normative_data = {k: [] for k in data_mahalanobis["feat"]}
            for e, feat in enumerate(data_mahalanobis["feat"]):
                alldata = data_mahalanobis["data_cn"][e]
                numvertex = alldata.shape[1]
                ...
                for i in range(numvertex):
                    ...
                    sex_coefficient = coefficients[2]
                    ...
                    # Append the results to normative_data
                    normative_data[feat].append([intercept, age_coefficient, sex_coefficient, std_residuals])
                print("here")
=======
            ...
            print("here")
>>>>>>> 31671d7b30a9452e1374b614c5a8f2cec1bee30e
