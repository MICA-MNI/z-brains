...
DEFAULT_LESION_DIR = Path("results/lesiondata/MICs")
DEFAULT_WSCORE_ROOT = Path("/host/verges/tank/data/BIDS_MICs/derivatives/zbrains_WB")
DEFAULT_OUTPUT_DIR = Path("results/lesion_wscore_overlap")
DEFAULT_MICS_DERIVATIVES_ROOT = Path("/host/verges/tank/data/BIDS_MICs/derivatives")
DEFAULT_HEMI_VERTICES = 32492
# Hippunfold surface density whose W-score maps and cavity labels are appended to
# the cortical data. Both MICs and the HippUnfold-v2 NOEL run use den-8k.
