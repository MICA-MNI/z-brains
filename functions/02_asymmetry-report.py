...
def report_block_template(figPath, subject='', session='', sex='', age='', featList_ctx='', featList_sctx='', featList_hipp=''):
    ...
    sctx_block = ('<p style="text-align:left;margin-left=-144px;margin-top=-500px;"> <a href="{figPath}_sctx-mz.png" target="_blank">'
                 '<img style="height:400px;margin-top:0;" src="{figPath}_sctx-mz.png">'
                 '</a></p>')
    hipp_block = (
        '<p style="text-align:left;margin-left=-144px;margin-top=-500px;"> <a href="{figPath}_hipp-mz.png" target="_blank">'
        '<img style="height:400px;margin-top:0;" src="{figPath}_hipp-mz.png">'
        '</a></p>')

    # FLAIR
    if 'flair' in featList_ctx:
        flair_ctx_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_ctx-flair.png" target="_blank">'
    ...
    if 'flair' in featList_sctx:
        flair_sctx_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_sctx-flair.png" target="_blank">'
    ...
    if 'flair' in featList_hipp:
        flair_hipp_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_hipp-flair.png" target="_blank">'
    ...
    if 'qt1' in featList_ctx:
        qt1_ctx_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_ctx-qt1.png" target="_blank">'
    ...
    if 'qt1' in featList_sctx:
        qt1_sctx_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_sctx-qt1.png" target="_blank">'
    ...
    if 'qt1' in featList_hipp:
        qt1_hipp_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_hipp-qt1.png" target="_blank">'
    ...
    if 'adc' in featList_ctx:
        adc_ctx_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_ctx-adc.png" target="_blank">'
    ...
    if 'adc' in featList_sctx:
        adc_sctx_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_sctx-adc.png" target="_blank">'
    ...
    if 'adc' in featList_hipp:
        adc_hipp_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_hipp-adc.png" target="_blank">'
    ...
    if 'thickness' in featList_ctx:
        thickness_ctx_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_ctx-thickness.png" target="_blank">'
    ...
    if 'thickness' in featList_sctx:
        thickness_sctx_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_sctx-thickness.png" target="_blank">'
    ...
    if 'thickness' in featList_hipp:
        thickness_hipp_block = ('<p style="text-align:left;margin-left=-144px;"> <a href="{figPath}_hipp-thickness.png" target="_blank">'
    ...
    report_block = (
        ...
        'color:#181818"> Clinical report &nbsp; | &nbsp; <b> Asymmetry </b> </p>'
        ...
        'color:#13365d"> <b> Blue </b> = Right > Left </p>'
        '<p style="margin-bottom:0;margin-top:0;font-family:gill sans,sans-serif;text-align:center;font-size:14px;'
        'color:#b31b2c"> <b> Red </b> = Left > Right </p> <hr>' + '<br>' +
        ...
        'color:#181818"> <b> Multivariate cortical asymmetry </b> </br> (<i>{featList_ctx}</i>) </p>' + ctx_block +
        '</br>'

        '<p style="margin-bottom:0;margin-top:0;font-family:gill sans,sans-serif;text-align:center;font-size:14px;'
        'color:#181818"> <b> Multivariate subcortical </b> </br> (<i>{featList_sctx}</i>) </p>' + sctx_block + '</br>'

        '<p style="margin-bottom:0;margin-top:0;font-family:gill sans,sans-serif;text-align:center;font-size:14px;'
        'color:#181818"> <b> Multivariate hippocampal asymmetry </b> </br> (<i>{featList_hipp}</i>) </p>' +
         hipp_block + '</br>'
